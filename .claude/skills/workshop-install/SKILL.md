...
| 파일                          | 내용                    |
| ----------------------------- | ----------------------- |
| `docs/INSTALLATION.md`        | 설치 개요, Quick Setup  |
| `docs/INSTALLATION_MAC.md`    | Mac 단계별 설치 가이드  |
| `docs/INSTALLATION_WIN.md`    | Windows 단계별 설치 가이드 |
| `docs/CLAUDE_CODE_SETUP.md`   | Bedrock 연동 설정       |
