...
비개발 직군을 위한 UI PoC 워크숍 모노레포입니다. AI 도구(MCP 서버)를 활용하여 에셋 생성과 웹 프로토타이핑 워크플로우를 제공합니다.
...
- [워크숍 런북](./packages/workshop/) — 수강자용 lab 가이드 (`packages/workshop/content/`)
...
- MCP 서버 패키지는 Controller-Service-Repository 패턴을 사용합니다.
