...
> **참고**: Ghostty 설치가 어려운 경우, Windows Terminal 또는 PowerShell을 사용해도 됩니다.

---

## 2. scoop 설치 (패키지 매니저)

이후 Git, Node.js 등을 터미널에서 간편하게 설치하기 위해 scoop을 먼저 설치합니다.
...
> 3단계에서 scoop으로 glow를 함께 설치했다면 바로 사용할 수 있습니다.
