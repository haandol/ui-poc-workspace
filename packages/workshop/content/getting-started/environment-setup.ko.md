...
이벤트 대시보드 좌측의 **Get AWS CLI credentials** 링크를 클릭하여 크레덴셜을 확인합니다.

![크레덴셜 가져오기](/static/images/getting-started/get-credentials.png)

아래와 같이 AWS 크레덴셜(Access Key, Secret Access Key, Session Token)이 표시되는지 확인합니다.

![AWS 크레덴셜](/static/images/getting-started/aws-credentials.png)
